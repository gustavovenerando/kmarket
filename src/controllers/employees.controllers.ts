...
export const listOneEmployeesController = async (
	req: Request,
	res: Response
) => {
...
export const updateEmployeesController = async (
	req: Request,
	res: Response
) => {
	const id = req.params.id;
	...
	const employee = await updateEmployeesService(id, {
		name,
		email,
		password,
		isAdm,
...
export const deleteEmployeesController = async (
	req: Request,
	res: Response
) => {
	const id = req.params.id;
