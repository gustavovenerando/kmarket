...
employeeRouter.get("", authTokenMiddleware, validationAdmMiddleware, listEmployeesController);
employeeRouter.get("/:id", authTokenMiddleware, validationAdmMiddleware, listOneEmployeesController);
employeeRouter.patch("/:id", authTokenMiddleware, validationAdmMiddleware, updateEmployeesController);
employeeRouter.delete("/:id", authTokenMiddleware, validationAdmMiddleware, deleteEmployeesController);
