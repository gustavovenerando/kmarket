...
loyaltyCustomerRoutes.post('', authTokenMiddleware, validationSchemaMiddleware(loyaltyCustomerSchema), createLoyaltyCustomerController)
...
loyaltyCustomerRoutes.patch('/:id', authTokenMiddleware , validationAdmMiddleware, validationSchemaMiddleware(loyaltyCustomerSchema), updateLoyaltyCustomersController)
